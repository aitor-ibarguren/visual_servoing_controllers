...
#ifndef VISUAL_SERVOING_CONTROLLER__PID_IMP_HPP_
#define VISUAL_SERVOING_CONTROLLER__PID_IMP_HPP_
...
public:
  PID6D(const Eigen::VectorXd & p, const Eigen::VectorXd & i, const Eigen::VectorXd & d)
  : kp_(p),
    ki_(i),
    kd_(d),
    integral_(Eigen::VectorXd::Zero(6)),
    prev_error_(Eigen::VectorXd::Zero(6))
  {
  }
...
#endif  // VISUAL_SERVOING_CONTROLLER__PID_IMP_HPP_